    ...
    <div className="flex-1 p-8 min-h-screen bg-gray-50">
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          {/* Personagens */}
          <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col max-h-[320px]">
              ...
              <div className="flex-1 overflow-y-auto pr-2 -mr-2">
                <div className="grid grid-cols-2 gap-3">
                  {characters.map((character) => (
                    <div
                      key={character._id}
                      className="border-2 border-gray-200 rounded-lg p-3 hover:border-purple-300 hover:shadow-md transition cursor-pointer group"
                    >
                      <div className="flex items-start gap-3">
                        {/* Bolinha de cor do personagem */}
                        <div
                          className="w-10 h-10 rounded-full shrink-0 flex items-center justify-center text-white font-bold text-sm"
                          style={{ backgroundColor: character.defaultColor || '#9333ea' }}
                        >
                          {character.name.charAt(0).toUpperCase()}
                        </div>
                        
                        <div className="flex-1 min-w-0">
                          <h4 className="font-semibold text-gray-800 truncate group-hover:text-purple-600 transition">
                            {character.name}
                          </h4>
            ...
            {characters.length > 6 && (
              <div className="mt-3 pt-3 border-t border-gray-200 text-center">
                <p className="text-xs text-gray-500">
                  ↕️ Role para ver mais personagens
                </p>
              </div>
            )}
          </div>
